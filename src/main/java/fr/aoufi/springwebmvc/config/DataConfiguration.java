...
@EnableJpaRepositories(basePackages = "fr.aoufi.springwebmvc.dao", entityManagerFactoryRef = "entityManagerFactory")
public class DataConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
		...
		localContainerEntityManagerFactoryBean.setPackagesToScan("fr.aoufi.springwebsample.model");
